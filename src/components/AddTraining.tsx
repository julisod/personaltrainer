...
import { ExistingCustomer, NewTraining } from "../../types";

interface ComponentProps { newTraining: (training: NewTraining) => void};

function AddTraining(props: ComponentProps) {
    const [open, setOpen] = useState(false);
    const [training, setTraining] = useState<NewTraining>({date: new Date(), duration:"", activity:"", customer: null});
    ...
    const handleSave = () => {
        ...
        setTraining({date: new Date(), duration:"", activity:"", customer: null});
        handleClose();
    };
        ...
        <Dialog
            ...
            <DialogContent>
                <FormControl variant="standard" fullWidth>
                    ...
                    >
                        {customers.map((customer: ExistingCustomer, i) =>
